...
class MainWindow(MainWindowUI, MainWindowBase):
    ...
    def __init__(self, parent=None):
		...
		# QtAds.CDockManager.setConfigFlag(QtAds.CDockManager.FloatingContainerForceQWidgetCustomStyledTitleBar, True)
		# self.setStyleSheet("#floatingTitleBar[maximized=\"true\" { qproperty-maximizeIcon: url(:/ads/images/close-button.svg), url(:/ads/images/close-button_disabled.svg) disabled;}]");
