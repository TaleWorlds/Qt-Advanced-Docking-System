...
void DockFocusControllerPrivate::updateDockWidgetFocus(CDockWidget* DockWidget)
{
    ...
    {
        Window->setProperty(
            FocusedDockWidgetProperty,
            QVariant::fromValue(QPointer<CDockWidget>(DockWidget)));
    }
    ...
    if (NewFocusedDockArea && (FocusedArea != NewFocusedDockArea))
    {
        ...
        QObject::connect(FocusedArea, SIGNAL(viewToggled(bool)), _this,
                         SLOT(onFocusedDockAreaViewToggled(bool)));
    }
...
void CDockFocusController::onDockWidgetVisibilityChanged(bool Visible)
{
    ...
    {
        Q_EMIT d->DockManager->focusedDockWidgetChanged(d->OldFocusedDockWidget,
                                                        DockWidget);
    }
}
...
//===========================================================================
void CDockFocusController::onApplicationFocusChanged(QWidget* focusedOld,
                                                     QWidget* focusedNow)
{
    Q_UNUSED(focusedOld);
...
//===========================================================================
void CDockFocusController::notifyFloatingWidgetDrop(
