...
protected:
    ...
    /**
     * Creates and initializes a dockwidget auto hide container into the given
     * area. Initializing inserts the tabs into the side tab widget and hides it
     * Returns nullptr if you try and insert into an area where the configuration
     * is not enabled
     */
    CAutoHideDockContainer* createAndSetupAutoHideContainer(
        SideBarLocation area, CDockWidget* DockWidget, int TabIndex = -1);
     ...
     */
    void dropFloatingWidget(CFloatingDockContainer* FloatingWidget,
     ...
     * TargetAreaWidget
     */
    void dropWidget(QWidget* Widget, DockWidgetArea DropArea,
                    CDockAreaWidget* TargetAreaWidget, int TabIndex = -1);

    /**
     * Adds the given dock area to this container widget
     */
    void addDockArea(CDockAreaWidget* DockAreaWidget,
                     DockWidgetArea area = ads::CenterDockWidgetArea);
     ...
     * splitters based on resize modes of dock widgets contained in the container.
     */
...
public:
     ...
     * This functions is a little bit faster than calling
     * openedDockAreas().isEmpty() because it returns as soon as it finds an open
     * dock area
     */
    ...
    /**
     * Checks if there are any DockWidgets on this container with
